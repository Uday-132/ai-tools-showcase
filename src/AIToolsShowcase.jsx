    ...
    <>
      <div
        ...
        style={{ 
          ...
          transition: 'transform 0.05s ease-out, scale 0.15s ease-out, opacity 0.15s ease-out'
        }}
      >
...
const ToolCard = ({ tool, index }) => {
  ...
  return (
    <div
      ref={cardRef}
      className={`relative group cursor-hover transition-all duration-500 animate-fadeInUp animate-cardFloat ${
...
const AIToolsShowcase = () => {
  ...
  // Fetch API tools when component mounts
  useEffect(() => {
    fetchToolsFromApi();
  }, []);

  useEffect(() => {
    const toolsToFilter = useApi ? apiTools : aiTools;
  ...
  }, [searchTerm, selectedCategory, apiTools, useApi]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white cursor-none smooth-scroll">
      <CustomCursor />
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        {[...Array(5)].map((_, i) => (
          <div
            key={`star-${i}`}
            className="absolute w-1 h-1 bg-white rounded-full opacity-60 animate-shootingStar"
            style={{
              left: `${Math.random() * 100}%`,
              top: `${Math.random() * 50}%`,
      ...
      <div className="relative z-10">
          ...
          <div className="flex flex-col gap-8 items-center justify-center">
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-300 cursor-hover ${
                  useApi ? 'bg-gradient-to-r from-purple-500 to-pink-500' : 'bg-gray-600'
                }`}
              >
                <span
              ...
              <span className="text-gray-300 text-sm">
                {useApi ? 'API Data' : 'Static Data'}
                {isLoadingApi && useApi && (
                  <span className="ml-2 text-purple-400 animate-pulse">Loading...</span>
                )}
              </span>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Your gateway to the most powerful AI tools for enhanced productivity and creativity.
                </p>
              </div>
              ...
              <div className="text-center">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white/5 rounded-lg p-4 backdrop-blur-sm border border-white/10">
                    <div className="text-2xl font-bold text-purple-400">{aiTools.length}</div>
                    <div className="text-xs text-gray-400 uppercase tracking-wide">AI Tools</div>
                  </div>
                  <div className="bg-white/5 rounded-lg p-4 backdrop-blur-sm border border-white/10">
              ...
              <div className="text-center md:text-right">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-center md:justify-end space-x-2 mt-3">
                    ...
                    <span className="text-xs text-gray-400">Live & Updated</span>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-white/5">
              <div className="flex flex-col md:flex-row items-center justify-between">
                <p className="text-xs text-gray-500 mb-2 md:mb-0">
                  © 2024 AI Tools Hub. Curated with ❤️ for the AI community.
                </p>
                <div className="flex items-center space-x-4">
                  <span className="text-xs text-gray-500">Made for developers & creators</span>
                  <div className="flex space-x-1">
        ...
        {showBackToTop && (
          <button
            onClick={scrollToTop}
            className="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 hover:scale-110 cursor-hover z-40 animate-bounce"
            style={{
